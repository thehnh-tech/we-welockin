...
export const TINTS: Tint[] = [
  { key: "bleu", label: "Blue", bg: "#dce8f3", fg: "#5a7db8" },
  { key: "rose", label: "Pink", bg: "#fbe4e0", fg: "#b07a70" },
  { key: "vert", label: "Green", bg: "#ddefdc", fg: "#54a078" },
  { key: "violet", label: "Purple", bg: "#ede3f0", fg: "#8a6b96" },
  { key: "ambre", label: "Amber", bg: "#f4e7d6", fg: "#b08646" },
  { key: "sable", label: "Sand", bg: "#ece7df", fg: "#6b6258" },
  { key: "sarcelle", label: "Teal", bg: "#d8e6e4", fg: "#4f8a86" },
];
